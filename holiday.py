...
open_pull_request_arden_university.png


The Python file arden_holiday_booking.py is a holiday booking calculator written for Arden University to budget on staff vacation booking. 

On a second look at the code, we figured that 3 functions read a list of hotel room types from a text file. A closer look suggests that we have a dictionary containing the hotel rooms and the their price list and decided to modify the code to read from the dictionary instead of the text file.